...
class PacienteForm(tk.LabelFrame):
    ...
    def obtenerPacienteDesdeFormulario(self):
        values = [e.get() for e in self.entries]
        paciente = None
        if '' in values:
...
class VerIMC(tk.Toplevel):
    def __init__(self,parent):
        ...
        self.paciente = parent.obtenerPaciente()
        self.calcularIMC()
...
class PacientesView(tk.Tk):
    ...
    def setControlador(self, ctrl):
        ...
        self.form.showIMC(ctrl.verImcPaciente)
    ...
    def obtenerPaciente(self):
        return self.form.obtenerPacienteDesdeFormulario()
